...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Dr. Adrian Vale — Cardiothoracic Surgeon & Researcher" },
      { name: "description", content: "Premium private practice of Dr. Adrian Vale. Two decades of cardiothoracic excellence, research, and patient-first care." },
      { property: "og:title", content: "Dr. Adrian Vale — Cardiothoracic Surgeon" },
      { property: "og:description", content: "Two decades of cardiothoracic excellence. Book a private consultation." },
